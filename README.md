...
Der arkumu.nrw Import Assistant ist eine Streamlit-Webanwendung, die Institutionen dabei unterstützt, ihre Metadaten vor dem Import auf arkumu.nrw auf Vollständigkeit zu prüfen. Zusätzlich bietet die App Metriken und Visualisierungen, die einen schnellen Überblick über den Metadatenbestand ermöglichen und potenzielle Fehler sichtbar machen. Die App wurde im Rahmen der Praxisarbeit im Zertifikatskurs **Data Librarian 2024/2025** am ZBIW der TH Köln entwickelt.
...
- Bereitstellung einer **schnellen Übersicht** über die hochgeladenen Metadaten, einschließlich zentraler Kennzahlen (z. B. Projekte, Akteur:innen, Ereignisse)
- **Visualisierung der Metadaten**, um Abweichungen oder Fehler sofort zu erkennen.  
