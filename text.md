...
Darüber hinaus ermöglichen Konfigurationsdateien im JSON-Format die Definition projektspezifischer Profile (z. B. für die KHM) sowie die Ablage der Validierungsregeln. Dadurch kann die App flexibel an verschiedene Hochschulen und Datenmodelle angepasst werden, ohne dass Änderungen am Programmcode selbst erforderlich sind.
...
Ein besonderer Schwerpunkt lag bei der Entwicklung auf der Code-Qualität. Funktionen sind sprechend benannt und konsistent dokumentiert. Durch die klare Trennung von Logik, Darstellung und Konfiguration ist die App modular aufgebaut und kann problemlos erweitert oder an neue Anforderungen angepasst werden.
